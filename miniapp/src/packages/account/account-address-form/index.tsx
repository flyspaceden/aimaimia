...
export default function AccountAddressFormPage() {
  ...
  return <View className='aim-page account-address-form-page'>
    <View className='account-address-form-intro'><Text className='account-address-form-intro__eyebrow'>{id ? '修改收货信息' : '添加新地址'}</Text><Text className='account-address-form-intro__title'>{id ? '确认最新的收货信息' : '让好物准确送达'}</Text><Text className='account-address-form-intro__description'>省市区使用微信标准行政区划，保存后将在当前账号内生效。</Text></View>

...
export default function AboutPage() {
  ...
  return <View className='about-page'>
    <View className='about-brand'><View className='about-brand__seal'>爱</View><Text>爱买买</Text><Text>AI 赋能农业电商平台</Text><Text>让每一份源头好物，更容易被看见。</Text></View>
    ...
    <Text className='about-copyright'>© 2026 爱买买. All rights reserved.</Text>
  </View>;
}

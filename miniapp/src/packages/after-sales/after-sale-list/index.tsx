...
export default function AfterSaleListPage() {
  ...
  return <AfterSaleAuthGate returnUrl='/packages/after-sales/after-sale-list/index'><View className='after-sale-list-page'>
    <View className='after-sale-list-hero'><View><Text className='after-sale-list-hero__eyebrow'>SERVICE CASES</Text><Text className='after-sale-list-hero__title'>我的售后</Text></View><Text className='after-sale-list-hero__count'>{items.length} <Text>条售后</Text></Text></View>

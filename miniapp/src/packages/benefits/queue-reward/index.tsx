...
export default function QueueRewardPage() {
  ...
  return <View className='aim-page benefits-page'>
    ...
    })}</View> : <BenefitsFeedback kind='empty' title='暂无活跃位置' description='符合当前规则的订单会自动进入队列' />}
    ...
    <Text className='benefits-note'>奖励会经过售后冻结期，最终可用金额以钱包流水为准。</Text>
  </View>;
}

...
import { ORDER_STATUS_META, formatMoney, formatOrderTime, shortOrderNo } from './order-utils';
...
export function MiniOrderCard({ order, busy, onOpen, onTrack, onConfirm, onRepurchase, onCancel }: Props) {
  ...
  return <View className='mini-order-card aim-card'>
    ...
    {onCancel || onTrack || onConfirm || onRepurchase ? <View className='mini-order-actions'>

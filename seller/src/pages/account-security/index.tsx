...
export default function AccountSecurityPage() {
  ...
  const handleSendOldCode = async () => {
    ...
    if (!phone) {
      message.warning('当前账号未绑定手机号，无法改手机。请联系创始人处理');
      return;
    }
    setOldSending(true);
    try {
      await sendSmsCode(phone);
      message.success(`验证码已发送到原手机 ${maskPhone(phone)}`);
              ...
              children: (
                <>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <Text strong>{currentPhone ? maskPhone(currentPhone) : '未绑定'}</Text>
                  </div>
                    ...
                    >
                      <Space.Compact style={{ width: '100%' }}>
                        ...
                        <Button
                          ...
                          loading={oldSending}
                          disabled={oldCountdown > 0 || !currentPhone}
                          style={{ minWidth: 140 }}
                        >

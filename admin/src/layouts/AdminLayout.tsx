  ...
  routes: [
    ...
    },
    {
      ...
      permissionAny: [
        ...
        PERMISSIONS.DIGITAL_ASSETS_READ,
        PERMISSIONS.GROWTH_READ,
        PERMISSIONS.NORMAL_SHARE_READ,
        PERMISSIONS.VIP_GIFT_READ,
      ],
      routes: [
        ...
        { path: '/growth', name: '积分成长', icon: <RiseOutlined />, permission: PERMISSIONS.GROWTH_READ },
        {
          path: '/referrals',
          name: '推荐与拉新',
          icon: <TeamOutlined />,
          permissionAny: [PERMISSIONS.NORMAL_SHARE_READ, PERMISSIONS.BONUS_READ, PERMISSIONS.GROWTH_READ],
        },
    ...
    },
    {
      ...
      permissionAny: [PERMISSIONS.CS_READ, PERMISSIONS.ANNOUNCEMENTS_READ],
      routes: [
        { path: '/announcements', name: '消息公告', permission: PERMISSIONS.ANNOUNCEMENTS_READ },
        { path: '/cs/workstation', name: '对话工作台', permission: PERMISSIONS.CS_READ },
        { path: '/cs/tickets', name: '工单管理', permission: PERMISSIONS.CS_READ },
        { path: '/cs/faq', name: 'FAQ 管理', permission: PERMISSIONS.CS_READ },
        { path: '/cs/quick-entries', name: '快捷入口配置', permission: PERMISSIONS.CS_READ },
        { path: '/cs/quick-replies', name: '坐席快捷回复', permission: PERMISSIONS.CS_READ },
        { path: '/cs/dashboard', name: '数据看板', permission: PERMISSIONS.CS_READ },
      ],
    },
    {
      path: '/system',
      ...
      routes: [
        ...
        { path: '/visual-agent', name: 'AI Visual Agent', icon: <SafetyOutlined />, permission: PERMISSIONS.ADMIN_VISUAL_AGENT_MANAGE },

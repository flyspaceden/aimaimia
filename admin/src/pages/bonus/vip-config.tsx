...
const CONFIG_SCHEMA: ConfigMeta[] = [
  ...
  { key: 'VIP_DIRECT_REFERRAL_PERCENT', label: 'VIP直推佣金占比', group: 'ratio', type: 'percent', min: 0, max: 1, step: 0.01, description: 'VIP 推荐人从被推荐人后续普通商品订单利润中获得的持续佣金比例。被推荐人购买 VIP 礼包本身不单独发放推荐奖。', defaultValue: 0 },

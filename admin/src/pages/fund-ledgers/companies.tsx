...
export default function IndustryFundCompaniesPage() {
  ...
  return <div className="fund-workspace">
    ...
    <Drawer title="公司产业基金" width={920} open={!!params.get('detail')} onClose={()=>update({detail:undefined},false)} destroyOnHidden>{params.get('detail')&&<CompanyDetail companyId={params.get('detail')!} embedded returnTo={current}/>}</Drawer>
  </div>;
}

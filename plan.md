...
- [x] **DR06** 买家 App：普通成长页、推荐页、我的页推荐弹窗、VIP 中心展示普通/VIP 直推收益、自动 VIP 门槛、VIP 关系切换边界和 VIP 礼包购买不发直推奖的说明。

...
- [x] **MP-PROD09C** staging 已验收业务语义收口：40 个核心商城/后台 Service 或 DTO 的 Git blob 精确固定到 `staging@acc0e08c`；Payment/Company/SF/Auth/Schema 9 个允许差异均形成生产强化说明和 Delivery 排除断言。恢复 staging 的地址、购物车、预约/参团、客服、商品/推荐、个人资料、团购后台、组合商品、卖家发货、微信提现渠道查询、注销账号资金围栏、团购返还、分润/推荐及订单支付退款测试。验证为后端 260/3133、真实 PG 5 suites/9、App 30/127+TS、Admin 12+build、Seller 12+build、miniapp 303+双构建、scripts 256；App/根 src/Delivery 改动 0。

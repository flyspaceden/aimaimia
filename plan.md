...
- [x] 在最新 `origin/staging` 的干净 worktree 完成 Prisma 空库迁移、后端关键测试、小程序/App/Web 类型与构建、卖家/管理 Mock 浏览器检查和微信开发者工具目标路由巡检；本轮未 commit、未 push、未部署。
- [ ] 在 staging 历史数据副本部署迁移并打开灰度开关，完成真实 PostgreSQL 并发、真实微信支付/退款、卖家备货、订阅提醒、真机扫码核销和关联分润/数字资产/售后窗口验收；须另获部署/资金操作授权。

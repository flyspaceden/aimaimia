...
- [ ] **团长优惠后利润分成 V3 与平台利润安全收口**（2026-07-10 进行中）
  ...
  - **已完成**: 支付利润快照、会员与团长 V3 归因、按订单配置快照月结、配置/SKU Serializable advisory lock 硬校验、V3 后台参数与买家展示、完整配置版本回滚隔离。
  - **待完成**: 退款守恒复审收口、利润对账/人工调整工作流、管理页面最终验收、空库迁移重放与全量测试、独立全线审查和最终提交。

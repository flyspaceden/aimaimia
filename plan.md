...
- [✅] **APP-HOME-HERO01** 首页品牌文案（2026-06-15）：买家 App 首页顶部移除时段问候和随机 AI 引导语，固定展示"消费者就是生产力，是社会价值的创造者。"；AI 光球下方移除快捷指令气泡，改为两行使命文案"让每个人创造一个属于自己的世界 / 为全世界创造一个共生的未来"；新增 `HOME_HERO_STATEMENT` / `HOME_MISSION_LINES` 纯函数常量测试，防止旧文案回归。

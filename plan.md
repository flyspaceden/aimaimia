...
- [ ] Phase 2 · 后端剩余 DTO + 防重锁 + 续付链路 + 横幅（14 任务）— mapOrder 完整版（Company join + logisticsSummary）/ pending checkout 接口 / resume 接口 / 防重锁 / 横幅 / checkout-pending 页 / 6001 改造 / 409 Modal / me 页"未完成支付"入口

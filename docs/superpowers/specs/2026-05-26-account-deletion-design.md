...
> ⚠️ **本文档已被 `2026-06-04-account-deletion-immediate-design.md` 替代（SUPERSEDED，2026-06-04）。**
> 本版采用 30 天冷静期 + cron 执行；现行方案改为**即时注销、不可撤销**（取消冷静期/cron/cancel）。请以新版为准，本文件仅作历史留档。

...
- [x] **Step 3: 确认 `shouldShowVipPromo` 无残留引用**
...
- [x] **Step 1: 删除 VIP 硬拦截块（原 388-417 行）**
...
- [x] **Step 2: handleCheckout 加 VIP 守卫（物理隔离）+ 新增分享 handler**
...
- [x] **Step 3: 审查 Agent（CLAUDE.md 强制流程 9）**

...
- [ ] **Step 1: Update `ShippingRule` to formula fields**
...
- [ ] **Step 2: Add `OrderShippingCost` model**
...
- [ ] **Step 3: `ProductSKU.weightGram` 改必填**
...
- [ ] **Step 2: 注册到 `ShippingRuleModule` providers + exports**
...
- [ ] **Step 1: `ShippingCalculationResult` 类型与服务边界**
...
- [ ] **Step 5: 保留 `calculateShippingFee()` 兼容签名**
...
- [ ] **Step 1: 预结算与 CheckoutSession 创建使用 `calculateShippingDetail`**
...
- [ ] **Step 3: 支付回调直接使用 `session.shippingFee`**
...
- [ ] **Step 6: 用 `App.useApp()` 拿 message/modal hook**
...
- [ ] **Step 3: plan-treeforuser.md**

替换旧"金额区间 × 地区 × 重量固定费"段落，引用本 spec。

- [ ] **Step 4: app-tofix3.md**
...
- [ ] **Step 3: 启动审查 Agent（subagent_type: Explore）**

...
- [x] C1a：普通商品无收货地址时仍展示商品与基础金额，修复空白卡片拉伸；无可用自提点时在普通/团购/VIP 三入口提供明确点击提示。
...
- [x] D2a：部署到 staging，应用迁移，配置独立凭证密钥并开启 staging 灰度开关；完成 API/PM2/后台静态页和微信开发者工具基础验活。
- [ ] D2b：在有效测试账号、自提点和订单夹具下完成真实微信支付、卖家备货、凭证/扫码核销、受控退款与真机验收；main 发布另行授权。

...
- [x] **Step 1: Add schema enum and fields**
...
- [x] **Step 1: Write failing tests for no-switch rule**
...
- [x] **Step 2: Implement canonical bind check**
...
- [x] **Step 3: Change VIP referral no-switch behavior**
...
- [x] **Step 1: Write tests for all upgrade branches**
...
- [x] **Step 2: Extract VIP upgrade context helper**
...
- [x] **Step 3: Change `assignVipTreeNode` signature**
...
- [x] **Step 4: Remove one-time A reward from B VIP purchase**
...
- [x] **Step 5: Run VIP activation tests**
...
- [x] **Step 2: Implement BonusService public method**
...
- [x] **Step 3: Inject BonusService into order receive paths**
...
- [x] **Step 2: Generalize scheme sets**
...
- [x] **Step 3: Update void mirror metadata**
...
- [x] **Step 2: Include fields in list APIs**
...
- [x] **Step 1: Add normal config fields**
...
- [x] **Step 3: Update VIP config text**
...
- [x] **Step 4: Update growth relation table**
...
- [x] **Step 2: Update ordinary growth copy**
...
- [x] **Step 3: Update VIP growth copy**
...
- [x] **Step 4: Update referral page non-VIP copy**
...
- [x] **Step 1: Write dry-run capable script**
...
- [x] **Step 4: Run admin verification**

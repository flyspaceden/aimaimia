...
| 卖家中心订单打印清单 | Seller 前端订单详情的“打印”改为“打印清单”，打印页先展示订单号、买家匿名信息、地区、电子面单号、商品明细/数量/小计，再附电子面单 iframe 并自动唤起浏览器打印，便于卖家拣货核对 | 2026-06-18 | `seller/src/pages/orders/detail.tsx`, `seller/src/utils/waybillPrint.ts`, `seller/test/waybillPrint.test.ts` |

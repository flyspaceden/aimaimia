...
| 团购即时推荐码与售后规则文案 | 团购首页、详情页、扫码落地页、付款页、当前团购面板和切换团购弹窗统一新规则：付款成功后立即生成团购推荐码；推荐返还付款后冻结、确认收货后释放；团购订单不支持退换货或退款，仅收货后24小时内质量问题联系客服补发；付款页继续明确团购现金支付且不可使用消费积分、平台红包或团购返还余额抵扣 | 2026-06-29 | `app/group-buy/index.tsx`, `app/group-buy/[activityId].tsx`, `app/group-buy/checkout.tsx`, `app/gb/[code].tsx`, `src/components/group-buy/GroupBuyCurrentPanel.tsx`, `src/components/group-buy/GroupBuyPurchaseGuardSheet.tsx` |

...
| Group ID | 内容 | 备注 |
|---|---|---|
| `1a895d0f-8d07-4880-a3e0-e047c20dde69` | 关于爱买买页面更新：联系邮箱改为 `zenghaifeng13@163.com`，删除「微信客服」占位行与简介「当前为前端占位内容。」尾巴，简介补充「农产品信用确权」，备案号更新为「粤ICP备2023047684号-6A」 | **当前生效** ✅，commit `e84fcab`（2026-05-19），纯 JS/TS 无原生改动；Android update `019e3e78-0242-7595-bc37-7c5315164307`，iOS update `019e3e78-0242-7684-8bba-5c4c9f4a7808`；带 `EXPO_PUBLIC_ALIPAY_SANDBOX=true` |

...
async function main() {
  ...
  const permissions = [
    ...
    { code: 'fund_ledgers:read', module: 'fund_ledgers', action: 'read', description: '查看平台基金逐笔账本' },
    { code: 'industry_funds:read', module: 'industry_funds', action: 'read', description: '查看公司产业基金账本' },
    { code: 'industry_funds:pay', module: 'industry_funds', action: 'pay', description: '登记公司公对公付款及查看凭证' },
    { code: 'industry_funds:reverse', module: 'industry_funds', action: 'reverse', description: '产业基金登记冲正与回款' },
  ...
  const couponCampaigns = [
    ...
    },
    {
      ...
      totalQuota: 100000, issuedCount: 0, maxPerUser: 99, growthExchangeEnabled: true, validDays: 14,
      startAt: new Date('2026-01-01'), endAt: new Date('2026-12-31'), createdBy: superAdmin.id,
    },
    {
    ...
    },
    {
      ...
      totalQuota: 50000, issuedCount: 0, maxPerUser: 99, growthExchangeEnabled: true, validDays: 14,
      startAt: new Date('2026-01-01'), endAt: new Date('2026-12-31'), createdBy: superAdmin.id,
    },
    {
      ...
      totalQuota: 20000, issuedCount: 0, maxPerUser: 12, growthExchangeEnabled: true, validDays: 30,
      startAt: new Date('2026-01-01'), endAt: new Date('2026-12-31'), createdBy: superAdmin.id,
    },
  ];

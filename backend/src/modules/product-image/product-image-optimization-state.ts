...
const transitions: Record<ProductImageOptimizationStatus, readonly ProductImageOptimizationStatus[]> = {
  ...
  RECONCILING: [ProductImageOptimizationStatus.PENDING_REVIEW, ProductImageOptimizationStatus.SUCCEEDED, ProductImageOptimizationStatus.REJECTED, ProductImageOptimizationStatus.FAILED, ProductImageOptimizationStatus.EXPIRED],

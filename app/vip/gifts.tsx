...
import type { VipGiftOption, VipGiftItemInfo, CoverMode } from '../../src/types/domain/Bonus';
...
function GiftCoverImage({
  ...
  if (images.length === 0) {
    return (
      <View style={[style, coverStyles.placeholder]}>
        <MaterialCommunityIcons name="gift" size={48} color={VIP.goldPrimary} />
      </View>
    );
  }

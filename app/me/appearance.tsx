  ...
  return (
    <Screen contentStyle={{ flex: 1 }}>
      ...
      {isLoading ? (
        ...
        >
          <Animated.View entering={FadeInDown.duration(300)} style={[styles.previewCard, shadow.md, { backgroundColor: colors.surface, borderRadius: radius.lg, overflow: 'hidden' }]}>
            <LinearGradient
          ...
          <Animated.View entering={FadeInDown.duration(300).delay(80)} style={{ marginTop: spacing.lg }}>
            ...
            <View style={styles.avatarRow}>
              {avatarOptions.map((avatar, avatarIdx) => {
          ...
          <Animated.View entering={FadeInDown.duration(300).delay(160)} style={{ marginTop: spacing.lg }}>
            ...
            <View style={{ marginTop: spacing.sm }}>
              {options.map((option, optIdx) => {
                ...
                return (
                  <Animated.View key={option.id} entering={FadeInDown.duration(300).delay(50 + optIdx * 30)}>
                    <Pressable

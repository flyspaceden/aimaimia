...
export const sendForgotPasswordCode = (data: {
  ...
  client.post('/delivery-seller/auth/forgot-password/send-code', data);
...
}> => client.post('/delivery-seller/auth/forgot-password/list-companies', data);
...
export const resetForgotPassword = (data: {
  ...
  client.post('/delivery-seller/auth/forgot-password/reset', data);

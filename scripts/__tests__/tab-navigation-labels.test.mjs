...
test('bottom goods tab keeps the museum route and its seafood navigation icon', () => {
  ...
  assert.match(museumTab, /title: '商品'/);
  assert.match(museumTab, /tabBarAccessibilityLabel: '商品，浏览商品与企业'/);
